...
import 'package:moosik/utils/helper.dart';
import 'package:moosik/utils/lang_mapping.dart';
                        ...
                        child: Material(
                          ...
                          child: ListTile(
                            onTap: () {
                              launchUrl(
                                Uri.parse(
                                  'https://github.com/anandnet/moosik-Music/releases/latest',
                                ),
                ...
                children: [
                  ListTile(
                    ...
                    onTap: () {
                      launchUrl(
                        Uri.parse(
                          'https://github.com/anandnet/moosik-Music',
                        ),
                        mode: LaunchMode.externalApplication,
                      );
                    },
